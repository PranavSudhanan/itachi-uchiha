...
| 2 | **Chronicle** | **Swipe** or scroll along a moonlit stepping-stone path through a bamboo grove, past 10 stone steles carved with the chapters of his life (the age inlaid in red lacquer, the title in gold), each with a stone lantern that lights the one you're reading. The grove floor is a carpet of fallen bamboo leaves with moss creeping over it; the stepping stones are worn into low domes, sunk into the litter and spotted with lichen; the culms vary in girth and age (young green, older yellowing), with pale bloom below each node and drooping sprays of lance-shaped leaves; the steles have softened edges, lichen and damp creeping up from their feet; mist drifts low along the path and fireflies over the grass. |
...
- **Chronicle on a phone:** the camera stands back square on to the stele being read, so the whole slab fits between the title and a compact card, and the ↑ ↓ arrows flank the progress line in one row.
